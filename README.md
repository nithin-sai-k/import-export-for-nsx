...
The Import/Export for NSX tool enable customers to export an on-prem or VMware Cloud on AWS NSX-T configuration. This export can then be imported into Amazon Q Transform, which will convert NSX-T objects into native AWS objects.
